...
function Branches(props) {
  ...
  const columns = [
            { id: 'branch_name', label: 'User Name'},
            { id: 'emp_count', label: 'Address', align: 'left' },
            { id: 'emp_count', label: 'Pincode', align: 'left' },
            { id: 'emp_count', label: 'Area', align: 'left' },
            { id: 'emp_count', label: 'District', align: 'left' },
            { id: 'emp_count', label: 'State', align: 'left' },
            { id: 'emp_count', label: 'Email', align: 'left' },
            { id: 'emp_count', label: 'Phone', align: 'left' },
            { id: 'emp_count', label: 'Registered Date', align: 'left' },
  ];
  ...
  return (
      <div>
          ...
          {!stageLoading?
             <React.Fragment>
              <h2 style={{color:'#7c2333', fontFamily:'monospace'}}>Users</h2>
                ...
                <Tooltip title="Print list of users" placement="top">
                  <Fab  aria-label="add" onClick={()=>handleHide()} className={classes.addIcons}>
                        <PrintIcon />
                  </Fab>
                  </Tooltip>
                  <a href={url} download={'branches.csv'}>
                  <Tooltip title="Download list of users as .csv" placement="top">
                    <Fab
