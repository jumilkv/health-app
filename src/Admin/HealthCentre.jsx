...
import Style from './Style/HealthCentre';
...
function Branches(props) {
  ...
  return (
      <div>
          ...
          {!stageLoading?
             <React.Fragment>
             <h2 style={{color:'#7c2333', fontFamily:'monospace'}}>Health Centres</h2>
                ...
                <Tooltip title="Add Health Centre" placement="top">
                    <Fab  aria-label="add" >
                      <IconButton 
                ...
                <Tooltip title="Print list of health centre" placement="top">
                  <Fab  aria-label="add" onClick={()=>handleHide()} className={classes.addIcons}>
                        <PrintIcon />
                  </Fab>
                  </Tooltip>
                  <a href={url} download={'health_centre.csv'}>
                  <Tooltip title="Download list of health centre as .csv" placement="top">
                    <Fab
                ...
                <Modal visible={modalShow}  width="950" height="650" effect="fadeInUp">
                    <div className={classes.modalMain} >
                        <div className={classes.modalHead}>
                            <h3 className={classes.modalTitle}>{modalName + 'Health Centre'}</h3>
